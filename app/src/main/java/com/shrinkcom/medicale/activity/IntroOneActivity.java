...
public class IntroOneActivity extends AppCompatActivity {
    ...
    private int[] layouts;
    private TextView  btnNext,btn_skip;
      ...
      /*  btnSkip.setOnClickListener(new View.OnClickListener() {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (current < layouts.length) {
                    ...
                    userSession.setFirstTimeLaunch(true);
                    launchHomeScreen();
                }
            }
        });
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // checking for last page
                // if last page home screen will be launched
               Intent intent = new Intent(IntroOneActivity.this,SelectLanguageActivty.class);
    ...
    private void launchHomeScreen() {
       // prefManager.setFirstTimeLaunch(false);
        startActivity(new Intent(IntroOneActivity.this, LoginActivity.class));
        finish();
    }
