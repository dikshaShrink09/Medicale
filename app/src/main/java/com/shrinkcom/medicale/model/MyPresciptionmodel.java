...
public class MyPresciptionmodel {

    private String order_id;
    private String file;
    private String user_id;
    private String pharmacy_id;
    private String requested_pharmacy;
