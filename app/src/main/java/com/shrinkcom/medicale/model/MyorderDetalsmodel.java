...
public class MyorderDetalsmodel {

    String product_count,product_id,product_name,product_description,product_price,product_quantity,price_discounted,product_image
            ,product_indication,product_packing,product_discount,category_id,sub_category_id,created_by,approved_by,brand_id,
            created_at,status,vendor_type;

    public MyorderDetalsmodel(String product_count, String product_id, String product_name, String product_description, String product_price, String product_quantity, String price_discounted, String product_image, String product_indication, String product_packing, String product_discount, String category_id, String sub_category_id, String created_by, String approved_by, String brand_id, String created_at, String status, String vendor_type) {
